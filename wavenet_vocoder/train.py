...
import time
import traceback
from wavenet_vocoder.models.wavenet import wavenet
...
def GetArguments():
    ...
    parser.add_argument('--wavenet_train_steps', type=int, default=200000,
...
if __name__ == '__main__':
    args = GetArguments()
    wavenet_train(args, 'Wavenet_trained_logs', hparams, args.Wavenet_input)
